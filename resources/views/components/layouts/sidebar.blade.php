...
<div class="sidebar">
    <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
        ...
        <h1 class="font-weight-bold">{{$descricion['edit_nombre']}}</h1>
        <p class="mb-4">
            {{$descricion['edit_decricion']}}
        </p>
        <div class="d-flex justify-content-center mb-5">
            <a class="btn btn-outline-info mr-2" href="#"><i class="fab fa-twitter"></i></a>
            <a class="btn btn-outline-info mr-2" href="{{$descricion['facebook']}}"><i class="fab fa-facebook-f"></i></a>
            <a class="btn btn-outline-info mr-2" href="{{$descricion['github']}}"><i class="fab fa-github"></i></a>
